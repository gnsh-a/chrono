...
for i in {1..5}; do
    ...
    ./build/bin/jz_FEA_3243_check --nthreads 16 --preint >> output.txt 2>&1
done
...
for i in {1..5}; do
    ...
    ./build/bin/jz_FEA_3243_check_cudss --nthreads 16 --preint >> output.txt 2>&1
done
...
for ((res=2; res<=64; res*=2)); do
    ...
    for i in {1..5}; do
        ...
        ./build/bin/jz_FEA_3243_check --res$res --nthreads 16 --preint>> output.txt 2>&1
    done
    ...
    for i in {1..5}; do
        ...
        ./build/bin/jz_FEA_3243_check_cudss --res$res --nthreads 16 --preint>> output.txt 2>&1
    done
done
